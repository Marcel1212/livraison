...
class TraitementParCritere extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['id_user_traitement_par_critere', 'id_action_formation_plan', 'id_critere_evaluation', 'id_demande', 'flag_critere_evaluation', 'created_at', 'updated_at'];
