...
class Visites extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['id_demande_habilitation', 'date_visite', 'heure_visite', 'description_lieu', 'flag_visites', 'statut', 'created_at', 'updated_at','date_fin_visite','id_charger_habilitation_visite'];
