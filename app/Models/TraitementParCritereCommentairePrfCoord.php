 ...
 * @property User $user
 */
class TraitementParCritereCommentairePrfCoord extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'traitement_par_critere_commentaire_prf_coord';
     ...
     * @var array
     */
    protected $fillable = ['id_user_traitement_par_critere_commentaire', 'id_traitement_par_critere','code_traitement', 'flag_traitement_par_critere_commentaire', 'flag_traitement_par_critere_commentaire_traiter', 'commentaire_critere', 'commentaire_reponse', 'created_at', 'updated_at','flag_traite_par_user_conserne'];
