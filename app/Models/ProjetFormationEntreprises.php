...
/**
 * @property float $id_projet_formation_entreprises
 ...
 */
class ProjetFormationEntreprises extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'projet_formation_entreprises';
     ...
     * @var string
     */
    protected $primaryKey = 'id_projet_formation_entreprises';
