 ...
 * @property float $masse_salariale_previsionel
 * @property float $part_entreprise_previsionnel
 * @property string $commentaire_plan_formation
 * @property string $date_commentaire_plan_formation
 * @property string $date_traiter_commission_permanente
 * @property string $contact_professionnel_charge_plan_formation
