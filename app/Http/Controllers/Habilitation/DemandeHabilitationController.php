...
//        $typedomainepublic = "<option value='".@$domaineHabilitation->typeDomaineDemandeHabilitationPublic->id_type_domaine_demande_habilitation_public."'> " . $domaineHabilitation->typeDomaineDemandeHabilitationPublic->libelle_type_domaine_demande_habilitation_public. "</option>";
    ...
    public function extensiondomaineformation($id)
    {
        ...
        return view('habilitation.demande.extensiondomaineformation',compact('motifs','id'));
    }
    ...
    public function extensiondomaineformationstore(Request $request,$id,$id1)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($input['action'] == 'enregistrer') {
                    ...
                    $dateanneeencours = Carbon::now()->format('Y');
                    DemandeSuppressionHabilitation::create([
                        'code_demande_suppression_habilitation'=>'DED-'.Gencode::randStrGen(4, 5).'-'. $dateanneeencours,
                        'id_motif_demande_suppression_habilitation'=> $input['id_motif_demande_suppression_habilitation'],
                        'commentaire_demande_suppression_habilitation'=> $input['commentaire_demande_suppression_habilitation'],
                        'piece_demande_suppression_habilitation'=> $input['piece_demande_suppression_habilitation'],
                        'date_enregistrer_demande_suppression_habilitation'=> Carbon::now(),
                ...
                $demande_suppression_habilitation = DemandeSuppressionHabilitation::latest()->first();
                return redirect('demandehabilitation/' . Crypt::UrlCrypt($demande_suppression_habilitation->id_demande_suppression_habilitation) . '/'.Crypt::UrlCrypt($id).'/' . Crypt::UrlCrypt($idetape) . '/extensiondomaineformationedit')->with('success', 'Succes : Demande d\'extension effectuée avec succès');
            }
            return redirect('demandehabilitation/' . Crypt::UrlCrypt($id) . '/extensiondomaineformation')->with('error', 'Erreur : Une erreur s\'est produite');
        }
        return redirect('demandehabilitation/' . Crypt::UrlCrypt($id) . '/extensiondomaineformation')->with('error', 'Erreur : Une erreur s\'est produite');
    }
    ...
    public function extensiondomaineformationedit($id,$id1,$id2)
    {
        ...
        return view('habilitation.demande.extensiondomaineformationedit',compact('motifs',
            'id','id1','idetape','demande_extension','commentairenonrecevables',
...
//            'domaineDemandeHabilitations'));
        ...
        if ($request->isMethod('post')) {
            ...
            if ($input['action'] == 'enregistrer_info_demande') {
                $this->validate($request, [
                    ...
                    'commentaire_demande_suppression_habilitation.required' => 'Veuillez ajouter le commentaire de la demande d\'extension.',
                    'id_motif_demande_suppression_habilitation.required' => 'Veuillez ajouter un motif.',
                ]);
                ...
                return redirect('demandehabilitation/'. Crypt::UrlCrypt($id).'/'. Crypt::UrlCrypt($id1).'/' . Crypt::UrlCrypt(1) . '/extensiondomaineformationedit')->with('success', 'Succes : Demande d\'extension modifiée avec succès');
            }
            ...
            if ($input['action'] == 'enregistrer_domaine_demande') {
                ...
                return redirect('demandehabilitation/'. Crypt::UrlCrypt($id).'/'. Crypt::UrlCrypt($id1).'/' . Crypt::UrlCrypt(2) . '/extensiondomaineformationedit')->with('success', 'Succes : Domaine de formation enregistrer avec succès');
            }
            ...
            if ($input['action'] == 'AjouterFormateur'){
                ...
                return redirect('demandehabilitation/'. Crypt::UrlCrypt($id).'/'. Crypt::UrlCrypt($id1).'/' . Crypt::UrlCrypt(3) . '/extensiondomaineformationedit')->with('success', 'Succes : Domaine de formation enregistrer avec succès');
            ...
            if ($input['action'] == 'soumettreDemandeExtension') {
                ...
                return redirect('demandehabilitation/' . Crypt::UrlCrypt($id) . '/' . Crypt::UrlCrypt($id1) .'/'. Crypt::UrlCrypt(2) . '/extensiondomaineformationedit')->with('success', 'Succes : Demande d\'extension effectuée avec succès');
            }
        }
    }
    ...
    public function deletedomaineDemandeExtension($id,$id1,$id2){
        ...
        return redirect('demandehabilitation/'.Crypt::UrlCrypt($id).'/'.Crypt::UrlCrypt($id1).'/'.Crypt::UrlCrypt(2).'/extensiondomaineformationedit')->with('success', 'Succes : Information mise a jour  ');
