...
class ComiteGestionPfController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $Resultat = ComiteGestion::where('code_pieces_comite_gestion','=', 'PRF')->get();
        return view('comitegestionpf.index', compact('Resultat'));
    }
    ...
    public function create()
    {
        ...
        $planformations = []; /*PlanFormation::where([['flag_plan_formation_valider_par_processus','=',true],
                                            ...
                                            ->get();*/
        return view('comitegestionpf.create', compact('planformations'));
    }
    ...
    public function store(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            $input['code_comite_gestion'] = 'CG_PRF' . Gencode::randStrGen(4, 5) .'-'. $dateanneeencours;
            $input['code_pieces_comite_gestion'] = 'PRF';
            $typecomiteinfos = ConseillerParAgence::get_type_comite_gest_projet_formation();
            ...
            return redirect('comitegestionpf/'.Crypt::UrlCrypt($insertedId).'/'.Crypt::UrlCrypt(2).'/edit')->with('success', 'Succes : Enregistrement reussi ');
...
//dd($conseillers);
    ...
    public function update(Request $request, $id, $id1)
    {
        ...
        if ($request->isMethod('put')) {
            ...
            if ($data['action'] == 'Modifier'){
                ...
                return redirect('comitegestionpf/'.Crypt::UrlCrypt($id).'/'.Crypt::UrlCrypt(1).'/edit')->with('success', 'Succes : Information mise a jour reussi ');
            ...
            if ($data['action'] == 'Enregistrer_conseil_poour_comite'){
                ...
                if(count($verifconseillerexist) >= 1){
                    ...
                    return redirect('comitegestionpf/'.Crypt::UrlCrypt($id).'/'.Crypt::UrlCrypt(2).'/edit')->with('error', 'Erreur : Cette personne existe déjà dans ce comite de gestion. ');
                ...
                return redirect('comitegestionpf/'.Crypt::UrlCrypt($id).'/'.Crypt::UrlCrypt(2).'/edit')->with('success', 'Succes : Information mise a jour reussi ');
            ...
            if ($data['action'] == 'Traiter_cahier_plan'){
                ...
                return redirect('comitegestionpf/'.Crypt::UrlCrypt($id).'/'.Crypt::UrlCrypt(4).'/edit')->with('success', 'Succes : Information mise a jour reussi ');
    ...
    public function delete($id){
        ...
        return redirect('comitegestionpf/'.Crypt::UrlCrypt($idcomitegestion).'/'.Crypt::UrlCrypt(2).'/edit')->with('success', 'Succes : La personne a été supprimée du comite avec succès ');
    }
    ...
    public function editer($id,$id2,$id3)
    {
        ...
        return view('comitegestionpf.editer', compact(
    ...
    public function agrementupdate(Request $request, $id, $id2)
    {

        $id =  Crypt::UrldeCrypt($id); // Projet de formation
        $id2 =  Crypt::UrldeCrypt($id2);  // Comite
       ...
       if ($request->isMethod('post')) {
        ...
        //dd($data);
            ...
            //     return redirect('comitegestionpf/'.Crypt::UrlCrypt($idplan).'/'.Crypt::UrlCrypt($id2).'/'.Crypt::UrlCrypt($id3).'/editer')->with('success', 'Succes : Action de plan de formation Traité ');
            ...
            //         ]);
            //     //}
            //     return redirect('comitegestionpf/'.Crypt::UrlCrypt($id2).'/'.Crypt::UrlCrypt($id3).'/edit')->with('success', 'Succes : Les actions ont été validée ');
            ...
            // }
             ...
             if($data['action'] === 'Traiter_action_proj_formation_valider'){
                ...
                FicheAgrement::create([
                    ...
                    $plan = ProjetFormation::find($idplan);
                ...
                //}
                return redirect('comitegestionpf/'.Crypt::UrlCrypt($id2).'/'.Crypt::UrlCrypt(4).'/edit')->with('success', 'Succes : Les actions ont été validée ');
