...
class ComiteGestionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('comitegestion.index', compact('Resultat'));
    }
    ...
    public function store(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            $input['code_comite_gestion'] = 'CG' . Gencode::randStrGen(4, 5) .'-'. $dateanneeencours;
            $input['code_pieces_comite_gestion'] = 'PF';
            ...
            return redirect('comitegestion/'.Crypt::UrlCrypt($insertedId).'/'.Crypt::UrlCrypt(2).'/edit')->with('success', 'Succes : Enregistrement reussi ');
...
//dd($conseillers);
        ...
        return view('comitegestion.edit', compact('comitegestion','comitegestionparticipant','ficheagrements','conseiller','planformations','idetape'));
    }
    ...
    public function update(Request $request, $id, $id1)
    {
        ...
        if ($request->isMethod('put')) {
            ...
            if ($data['action'] == 'Modifier'){
                ...
                return redirect('comitegestion/'.Crypt::UrlCrypt($id).'/'.Crypt::UrlCrypt(1).'/edit')->with('success', 'Succes : Information mise a jour reussi ');
            ...
            if ($data['action'] == 'Enregistrer_conseil_poour_comite'){
                ...
                if(count($verifconseillerexist) >= 1){
                    ...
                    return redirect('comitegestion/'.Crypt::UrlCrypt($id).'/'.Crypt::UrlCrypt(2).'/edit')->with('error', 'Erreur : Cette personne existe déjà dans ce comite de gestion. ');
                ...
                return redirect('comitegestion/'.Crypt::UrlCrypt($id).'/'.Crypt::UrlCrypt(2).'/edit')->with('success', 'Succes : Information mise a jour reussi ');
            ...
            if ($data['action'] == 'Traiter_cahier_plan'){
                ...
                return redirect('comitegestion/'.Crypt::UrlCrypt($id).'/'.Crypt::UrlCrypt(4).'/edit')->with('success', 'Succes : Information mise a jour reussi ');
