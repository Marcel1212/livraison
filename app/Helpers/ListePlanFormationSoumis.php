...
{
    public static function get_liste_plan_formation_soumis($idUser)
    {
        ...
        $planformations = DB::table('vue_plan_formation_soumis_au_conseiller')->where([['id_user_conseiller','=',$idUser]])->get();
        //dd($planformations);
