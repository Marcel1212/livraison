                    ...
                    @isset($demande_annulation->id_action_plan)
                        ...
                        <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                ...
                                aria-controls="navs-top-demande-annulation-action" aria-selected="false">
                    ...
                    @isset($demande_annulation->id_plan_formation)
                        ...
                        <li class="nav-item">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                ...
                                aria-controls="navs-top-histortiqueactionformation" aria-selected="false">
                        ...
                        <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-top-demande-annulation" aria-controls="navs-top-demande-annulation"
                                aria-selected="false">
...
@isset($demande_annulation->commentaire_demande_annulation_plan)
{{ $demande_annulation->commentaire_demande_annulation_plan }}
@endisset
</textarea>
                                        </div>
                                    </div>
                            ...
                            <form method="POST" class="form"
                                action="{{ route($lien . '.update', \App\Helpers\Crypt::UrlCrypt($demande_annulation->id_demande_annulation_plan)) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="mb-1">
                                            <label>Commentaire <strong style="color:red;">(obligatoire si rejeté)*</strong>:
                                            </label>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" name="nombre_salarie_plan_formation"
                                                ...
                                                value="{{ @$planformation->nombre_salarie_plan_formation }}"
                                                disabled="disabled">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" name="masse_salariale" id="masse_salariale"
                                                class="form-control form-control-sm"
                                                value="{{ @$planformation->masse_salariale }}" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                        ...
                        <div class="modal animate__animated animate__fadeInDownBig fade" id="modalToggle"
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="card">
                                        <h5 class="card-header">Parcours de la demande d'annulation du plan de formation
                                        </h5>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    @if ($res->is_valide === false)
                                                                        <div class="row">
                                                                            ...
                                                                            <div>
                                                                                <span class="badge bg-label-danger">Validé
                        ...
                        <form id="editUserForm" class="row g-3" method="POST"
                            ...
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="billings-country">Motif de non-financement <strong
                                        style="color:red;">(obligatoire si le montant accordé est egal a
                                        0*)</strong></label>

                                <select class="form-select form-select-sm" data-allow-clear="true"
                                    name="motif_non_financement_action_formation"
                                    id="motif_non_financement_action_formation">
                                    <?= $motif ?>
                                </select>
                            </div>
                            <div class="col-md-6 col-12">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control form-control-sm" name="commentaire_action_formation" id="commentaire_action_formation"
                                        rows="6">{{ @$infosactionplanformation->commentaire_action_formation }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12 text-center">
                                ...
                                <button
                                    ...
                                    type="submit" name="action" value="Traiter_action_formation"
