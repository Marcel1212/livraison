                  ...
                  <div class="nav-align-top nav-tabs-shadow mb-4">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade <?php if($idetape==1){ echo "show active";} //if(count($comitegestionparticipant)<1){ echo "show active";} //dd($activetab); echo $activetab; ?>" id="navs-top-planformation" role="tabpanel">
                            <form  method="POST" class="form" action="{{ route($lien.'.update', [\App\Helpers\Crypt::UrlCrypt($comitegestion->id_comite_gestion),\App\Helpers\Crypt::UrlCrypt(1)]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="date" name="date_debut_comite_gestion"
                                                class="form-control form-control-sm" value="{{ $comitegestion->date_debut_comite_gestion }}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="date" name="date_fin_comite_gestion"
                                                class="form-control form-control-sm" value="{{ $comitegestion->date_fin_comite_gestion }}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <textarea class="form-control form-control-sm"  name="commentaire_comite_gestion" id="commentaire_comite_gestion" rows="6">{{ $comitegestion->commentaire_comite_gestion }}</textarea>
                                    ...
                                    <div class="col-12" align="right">
                                        ...
                                        <?php } ?>
                                        <a  href="{{ route($lien.'.edit',[\App\Helpers\Crypt::UrlCrypt($comitegestion->id_comite_gestion),\App\Helpers\Crypt::UrlCrypt(2)]) }}"  class="btn btn-sm btn-primary me-sm-3 me-1">Suivant</button>
                        ...
                        <div class="tab-pane fade <?php if($idetape==2){ echo "show active";} //if(count($comitegestionparticipant)<1){ echo "show active";} //dd($activetab); echo $activetab; ?>" id="navs-top-categorieplan" role="tabpanel">
                            ...
                            <form  method="POST" class="form" action="{{ route($lien.'.update', [\App\Helpers\Crypt::UrlCrypt($comitegestion->id_comite_gestion),\App\Helpers\Crypt::UrlCrypt(2)]) }}" enctype="multipart/form-data">
                                      @csrf
                                      @method('put')
                                      <div class="row">
                                          <div class="col-12 col-md-10">
                                              <label class="form-label" for="id_user_comite_gestion_participant">Conseiller <strong style="color:red;">*</strong></label>
                                              <select
                                                  id="id_user_comite_gestion_participant"
                              ...
                              <div class="col-12" align="right">
                                ...
                                <?php if (count($comitegestionparticipant)>=1){ ?>
                                        ...
                                        <a  href="{{ route($lien.'.edit',[\App\Helpers\Crypt::UrlCrypt($comitegestion->id_comite_gestion),\App\Helpers\Crypt::UrlCrypt(1)]) }}"  class="btn btn-sm btn-secondary me-sm-3 me-1">Précédant</button>
                                        <a  href="{{ route($lien.'.edit',[\App\Helpers\Crypt::UrlCrypt($comitegestion->id_comite_gestion),\App\Helpers\Crypt::UrlCrypt(3)]) }}"  class="btn btn-sm btn-primary me-sm-3 me-1">Suivant</button>
                        ...
                        <div class="tab-pane fade <?php if($idetape==3){ echo "show active";} //if(count($planformations)>0 and count($comitegestionparticipant)>=1){ echo "active";} ?>" id="navs-top-actionformation" role="tabpanel">
                            ...
                            <div class="col-12" align="right">
                                ...
                                <?php //if (count($comitegestionparticipant)>=1){ ?>
                                        ...
                                        <a  href="{{ route($lien.'.edit',[\App\Helpers\Crypt::UrlCrypt($comitegestion->id_comite_gestion),\App\Helpers\Crypt::UrlCrypt(2)]) }}"  class="btn btn-sm btn-secondary me-sm-3 me-1">Précédant</button>
                                        <a  href="{{ route($lien.'.edit',[\App\Helpers\Crypt::UrlCrypt($comitegestion->id_comite_gestion),\App\Helpers\Crypt::UrlCrypt(4)]) }}"  class="btn btn-sm btn-primary me-sm-3 me-1">Suivant</button>
                        ...
                        <div class="tab-pane fade<?php if($idetape==4){ echo "show active";} //if(count($ficheagrements)>=1 and count($comitegestionparticipant)>=1){ echo "active";} ?>" id="navs-top-cahieraprescomite" role="tabpanel">
                            ...
                            <?php  if(count($ficheagrements)>=1 and $comitegestion->flag_statut_comite_gestion == false){?>
                                <div class="col-12" align="right">
                                <form  method="POST" class="form" action="{{ route($lien.'.update', [\App\Helpers\Crypt::UrlCrypt($comitegestion->id_comite_gestion),\App\Helpers\Crypt::UrlCrypt(4)]) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                            ...
                            <div class="col-12" align="right">
                                ...
                                <?php if (count($ficheagrements)>=1){ ?>
                                        ...
                                        <a  href="{{ route($lien.'.edit',[\App\Helpers\Crypt::UrlCrypt($comitegestion->id_comite_gestion),\App\Helpers\Crypt::UrlCrypt(3)]) }}"  class="btn btn-sm btn-secondary me-sm-3 me-1">Précédant</button>
