                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <form method="POST" class="form"
                                        action="{{ route($lien . '.agrementupdate', [\App\Helpers\Crypt::UrlCrypt($planformation->id_plan_de_formation), \App\Helpers\Crypt::UrlCrypt($idcomite), \App\Helpers\Crypt::UrlCrypt($idetape)]) }}">
                                        @csrf
                                        @method('post')
                                ...
                                <div class="col-1"s>
                                    <a class="btn btn-sm btn-outline-secondary waves-effect"
                                        href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($idcomite), \App\Helpers\Crypt::UrlCrypt($idetape)]) }}">
                                        Retour</a>
                ...
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form id="editUserForm" class="row g-3" method="POST"
                            action="{{ route($lien . '.agrementupdate', [\App\Helpers\Crypt::UrlCrypt($infosactionplanformation->id_action_formation_plan), \App\Helpers\Crypt::UrlCrypt($idcomite), \App\Helpers\Crypt::UrlCrypt($idetape)]) }}">
                            @csrf
                            @method('post')
                            ...
                            <div class="col-12 col-md-3">
                                <label class="form-label" for="cout_total_fiche_agrement">Coût total fiche
                                    agrément</label>
                                <input type="number" class="form-control form-control-sm"
                            ...
                            <div class="col-md-4 col-12">
                                <label class="form-label" for="billings-country">Motif de validation <strong
                                        style="color:red;">(obligatoires)</strong></label>
