        ...
        <div class="col-xl-12">
            ...
            <div class="nav-align-top nav-tabs-shadow mb-4">
                ...
                <div class="tab-content">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            value="{{ @$projetetude->ncc_entreprises }}" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            value="{{ @$projetetude->raison_social_entreprises }}" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        <label>Localisation geographique </label>
                                        <input type="text" name="localisation_geographique_entreprise"
                                            ...
                                            value="{{ @$projetetude->localisation_geographique_entreprise }}"
                                            disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" name="repere_acces_entreprises" id="repere_acces_entreprises"
                                            ...
                                            value="{{ @$projetetude->repere_acces_entreprises }}" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" name="adresse_postal_entreprises"
                                            ...
                                            value="{{ @$projetetude->adresse_postal_entreprises }}" disabled="disabled">
                                    </div>
                                </div>
                                <br>
                                                        ...
                                                        <div class="col-md-4 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <textarea class="form-control" rows="3" id="exampleFormControlTextarea" name="contexte_probleme"
                                                                    style="height: 121px;" disabled="disabled"><?php echo $projetetude->contexte_probleme_projet_etude; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <textarea class="form-control" rows="3" id="exampleFormControlTextarea" name="objectif_general"
                                                                    style="height: 121px;" disabled="disabled"><?php echo $projetetude->objectif_general_projet_etude; ?></textarea>
                                                        ...
                                                        <div class="col-md-4 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <textarea class="form-control" rows="3" id="exampleFormControlTextarea" name="objectif_specifique"
                                                                    style="height: 121px;" disabled="disabled"><?php echo $projetetude->objectif_specifique_projet_etud; ?></textarea>
                                                        ...
                                                        <div class="col-md-4 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <textarea class="form-control" rows="3" id="exampleFormControlTextarea" name="resultat_attendu"
                                                                    style="height: 121px;" disabled="disabled"><?php echo $projetetude->resultat_attendu_projet_etude; ?></textarea>
                                                        ...
                                                        <div class="col-md-4 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <textarea class="form-control" rows="3" id="exampleFormControlTextarea" name="champ_etude"
                                                                    style="height: 121px;" disabled="disabled"><?php echo $projetetude->champ_etude_projet_etude; ?></textarea>
                                                        ...
                                                        <div class="col-md-4 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <textarea class="form-control" rows="3" id="exampleFormControlTextarea" name="cible" style="height: 121px;"
                                                                    disabled="disabled"><?php echo $projetetude->cible_projet_etude; ?></textarea>
                    ...
                    <div class="tab-pane fade <?php if ($planformation->flag_recevablite_plan_formation == true) {
                        echo 'show active';
                            ...
                            <tbody>
                                ...
                                @foreach ($actionplanformations as $key => $actionplanformation)
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            @can($lien . '-edit')
                                                <a onclick="NewWindow('{{ route($lien . '.show', \App\Helpers\Crypt::UrlCrypt($actionplanformation->id_action_formation_plan)) }}','',screen.width*2,screen.height,'yes','center',1);"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <select class="select2 form-select-sm input-group" data-allow-clear="true"
                                        name="id_motif_recevable" id="id_motif_recevable">
                                        <?= $motif ?>
                                    </select>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        <label>Commentaire recevabilite <strong style="color:red;">(obligatoire si non
                                                recevable)*</strong>: </label>
                                        <textarea class="form-control form-control-sm" name="commentaire_recevable_plan_formation"
                                            id="commentaire_recevable_plan_formation" rows="6">{{ @$planformation->commentaire_recevable_plan_formation }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12" align="right">
                                    <hr>
                ...
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form id="editUserForm" class="row g-3" method="POST"
                            action="{{ route($lien . '.update', \App\Helpers\Crypt::UrlCrypt($infosactionplanformation->id_action_formation_plan)) }}">
                            @csrf
                            @method('put')
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <input type="text" class="form-control form-control-sm"
                                    value="{{ @$infosactionplanformation->masse_salariale }}" disabled="disabled" />
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <input type="text" class="form-control form-control-sm"
                                    value="{{ @$infosactionplanformation->part_entreprise }}" disabled="disabled" />
                            </div>
                            <div class="col-12 col-md-3">
                                <label class="form-label" for="structure_etablissement_action_">Structure ou etablissemnt
                                    de formation</label>
                                <input type="text" class="form-control form-control-sm"
                            ...
                            <div class="col-12 col-md-3">
                                <label class="form-label" for="date_debut_fiche_agrement">Date debut de
                                    realisation</label>
                                <input type="text" class="form-control form-control-sm"
                            ...
                            <div class="col-12 col-md-3">
                                <label class="form-label" for="cout_total_fiche_agrement">Cout total fiche
                                    agrement</label>
                                <input type="number" class="form-control form-control-sm"
                            ...
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="billings-country">Motif de validationt <strong
                            ...
                            <div class="col-12 text-center">
                                ...
                                <button
                                    onclick='javascript:if (!confirm("Voulez-vous Traiter cette action ?")) return false;'
                                    type="submit" name="action" value="Traiter_action_formation_rejeter"
                                    class="btn btn-danger me-sm-3 me-1">Action à corriger</button>
                                <?php }else{?>
                                <div class="alert alert-info alert-dismissible fade show" role="alert">
                                    <div class="alert-body" style="text-align:center">
                                        Action déja traité
