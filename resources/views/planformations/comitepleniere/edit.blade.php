                    ...
                    <div class="tab-content">
                            ...
                            <form method="POST" class="form"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12" align="right">
                                        ...
                                        <a href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($comitepleniere->id_comite_pleniere), \App\Helpers\Crypt::UrlCrypt(2)]) }}"
                        ...
                        <div class="tab-pane fade <?php if ($idetape == 2) {
                            ...
                            <form method="POST" class="form"
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-10">
                                        <label class="form-label" for="id_user_comite_pleniere_participant">Conseiller
                            ...
                            <div class="col-12" align="right">
                                ...
                                <a href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($comitepleniere->id_comite_pleniere), \App\Helpers\Crypt::UrlCrypt(1)]) }}"
                                    class="btn btn-sm btn-secondary me-sm-3 me-1">Précédant</button>

                                    <?php if (count($comitepleniereparticipant)>=1){ ?>
                                    <a href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($comitepleniere->id_comite_pleniere), \App\Helpers\Crypt::UrlCrypt(3)]) }}"
                                        class="btn btn-sm btn-primary me-sm-3 me-1">Suivant</button>
                                        <?php } ?>
                        ...
                        <div class="tab-pane fade <?php if ($idetape == 3) {
                            ...
                            <div class="col-12" align="right">
                                ...
                                <a href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($comitepleniere->id_comite_pleniere), \App\Helpers\Crypt::UrlCrypt(2)]) }}"
                                    class="btn btn-sm btn-secondary me-sm-3 me-1">Précédant</button>
                                    <a href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($comitepleniere->id_comite_pleniere), \App\Helpers\Crypt::UrlCrypt(4)]) }}"
                                        class="btn btn-sm btn-primary me-sm-3 me-1">Suivant</button>
