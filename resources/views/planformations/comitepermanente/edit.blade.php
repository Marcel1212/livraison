...
?>
@if (auth()->user()->can('comitepermanente-edit'))
                        ...
                        <div class="tab-pane fade<?php if ($idetape == 4) {
                            ...
                            <div class="col-12" align="right">
                                <form method="POST" class="form"
                                    ...
                                    @method('put')
                                    <button
                                        onclick='javascript:if (!confirm("Vous allez Valider la commission permanente ? . Cette action est irréversible.")) return false;'
                                        type="submit" name="action" value="Traiter_cahier_plan"
