                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade <?php if ($idetape == 1) {
                            ...
                            <form method="POST" class="form"
                                action="{{ route($lien . '.update', [\App\Helpers\Crypt::UrlCrypt($cahier->id_cahier_plan_formation), \App\Helpers\Crypt::UrlCrypt(1)]) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                value="{{ @$cahier->code_cahier_plan_formation }}" disabled="disabled" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-12">
                                        ...
                                        <select id="id_departement" name="id_departement"
                                            ...
                                            required="required" onchange="changeFunction();">
                                            <option value="{{ $cahier->departement->id_departement }}">
                                                {{ $cahier->departement->libelle_departement }} </option>
                                            @foreach ($departements as $departement)
                                                <option value="{{ $departement->id_departement }}">
                                                    {{ $departement->libelle_departement }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-12">
                                        ...
                                        <select id="id_agence" name="id_agence" class="select2 form-select-sm input-group">
                                            <option value='{{ $cahier->agence->num_agce }}'>
                                                {{ $cahier->agence->lib_agce }}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-12">
                                        <div class="mb-1">
                                            ...
                                            <textarea class="form-control form-control-sm" name="commentaire_cahier_plan_formation"
                                                id="commentaire_cahier_plan_formation" rows="6">{{ $cahier->commentaire_cahier_plan_formation }}</textarea>
                                    ...
                                    <div class="col-12" align="right">
                                        ...
                                        <?php } ?>
                                        <a href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($cahier->id_cahier_plan_formation), \App\Helpers\Crypt::UrlCrypt(2)]) }}"
                        ...
                        <div class="tab-pane fade <?php if ($idetape == 2) {
                            ...
                            <form method="POST" class="form"
                                action="{{ route($lien . '.update', [\App\Helpers\Crypt::UrlCrypt($cahier->id_cahier_plan_formation), \App\Helpers\Crypt::UrlCrypt(2)]) }}"
                                enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <table class="table table-bordered table-striped table-hover table-sm" id="exampleData"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($planformations as $key => $planformation)
                                            <tr>
                                                <td>
                                                    <input type="checkbox" value="<?php echo $planformation->id_plan_de_formation; ?>"
                                                ...
                                                <td align="rigth">
                                                    {{ number_format($planformation->cout_total_demande_plan_formation, 0, ',', ' ') }}
                                                </td>
                                                <td align="rigth">
                                                    {{ number_format($planformation->cout_total_accorder_plan_formation, 0, ',', ' ') }}
                                                </td>
                            ...
                            <div class="col-12" align="right">
                                ...
                                <a href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($cahier->id_cahier_plan_formation), \App\Helpers\Crypt::UrlCrypt(1)]) }}"
                                    class="btn btn-sm btn-secondary me-sm-3 me-1">Précédant</button>
                                    <a href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($cahier->id_cahier_plan_formation), \App\Helpers\Crypt::UrlCrypt(3)]) }}"
                                        class="btn btn-sm btn-primary me-sm-3 me-1">Suivant</button>
                        ...
                        <div class="tab-pane fade<?php if ($idetape == 3) {
                            ...
                            <div class="col-12" align="right">
                                ...
                                <form method="POST" class="form"
                                    action="{{ route($lien . '.update', [\App\Helpers\Crypt::UrlCrypt($cahier->id_cahier_plan_formation), \App\Helpers\Crypt::UrlCrypt(3)]) }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <button
                                        onclick='javascript:if (!confirm("Vous allez soumettre ce cahier à la commission permanente ? . Cette action est irréversible.")) return false;'
                                        type="submit" name="action" value="Traiter_cahier_plan_soumis"
                                        class="btn btn-sm btn-success me-1 waves-effect waves-float waves-light">
                                ...
                                <?php }else{ ?>
                                <a onclick="NewWindow('{{ route($lien . '.etat', \App\Helpers\Crypt::UrlCrypt($cahier->id_cahier_plan_formation)) }}','',screen.width*1,screen.height,'yes','center',1);"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($cahierplansformations as $key => $planformation)
                                        <tr>
                                            ...
                                            <td align="rigth">
                                                {{ number_format($planformation->cout_total_accorder_plan_formation) }}
                                            </td>
                                            <td>{{ $planformation->date_soumis_plan_formation }}</td>
                                        </tr>
                                    @endforeach
