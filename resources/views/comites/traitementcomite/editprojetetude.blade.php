                ...
                <div class="nav-align-top nav-tabs-shadow mb-4">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade @if($idetape==4) show active @endif" id="navs-top-traitementinstructionprojetetude" role="tabpanel">
                            ...
                            <form method="POST" class="form" action="{{ route($lien.'.agrementupdate', [\App\Helpers\Crypt::UrlCrypt($projet_etude->id_projet_etude),\App\Helpers\Crypt::UrlCrypt($idcomite),\App\Helpers\Crypt::UrlCrypt($idetape)]) }}">
                                    @csrf
                                    @method('put')
                                <div align="right">
                            ...
                            <form  method="POST" class="form" action="{{ route($lien.'.agrementupdate', [\App\Helpers\Crypt::UrlCrypt($projet_etude->id_projet_etude),\App\Helpers\Crypt::UrlCrypt($idcomite),\App\Helpers\Crypt::UrlCrypt($idetape)]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row mt-2">
                                    <div class="row mt-2">
