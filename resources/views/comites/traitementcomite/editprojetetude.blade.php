                            ...
                            style="margin-top: 13px !important">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Date soumis à la commision</th>
                                        <th>Coût accordé</th>
                                        <th>Statut</th>
                                        <th>Action</th>
                                    </tr>
                                ...
                                @foreach ($listedemandesss as $key => $demande)
                                    <tr>
                                        ...
                                        <td>{{ date('d/m/Y h:i:s',strtotime(@$demande->date_soumis_cahier_plans_projets ))}}</td>
                                        <td align="rigth">{{ number_format(@$demande->montant_projet_instruction, 0, ',', ' ') }}</td>
                                        <td>
                                            @if(@$demande->flag_valider_comite_permanente_projet_etude ==true ||
                                                @$demande->flag_valider_comite_gestion_projet_etude == true)
                                        ...
                                        <td align="center" nowrap="nowrap">
                                            @can($lien.'-edit')
                                                <a href="{{ route($lien.'.editer.projetetude',[\App\Helpers\Crypt::UrlCrypt($comite->id_comite),\App\Helpers\Crypt::UrlCrypt($demande->id_demande),\App\Helpers\Crypt::UrlCrypt(1),\App\Helpers\Crypt::UrlCrypt($demande->id_cahier_plans_projets)]) }}"
