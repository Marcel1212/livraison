...
@section('content')
    ...
    @php($soustitre='Tenue de comite pour le cahier habilitation')
                        ...
                        <div class="col-xl-12">
                            ...
                            <div align="right">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        @if ($demandehabilitation->flag_traiter_commission_permanente == false)
                                            <form  method="POST" class="form" action="{{ route($lien.'.updater.planformation', [\App\Helpers\Crypt::UrlCrypt($comite->id_comite),\App\Helpers\Crypt::UrlCrypt($demandehabilitation->id_demande_habilitation),\App\Helpers\Crypt::UrlCrypt(1),\App\Helpers\Crypt::UrlCrypt($idcahier)]) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('put')


                                                    <button type="submit" name="action" value="Valider_demande_habilitations"
                                                    class="btn btn-sm btn-success me-1 waves-effect waves-float waves-light"
                                                    onclick='javascript:if (!confirm("Voulez-vous valider la demande habilitation ?")) return false;'>
                                    ...
                                    <?php $i = 0; ?>
                                        ...
                                        <?php $i += 1;?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a onclick="NewWindow('{{ route($lien.".show.cvformateur",\App\Helpers\Crypt::UrlCrypt($formateur->id_formateurs)) }}','',screen.width*2,screen.height,'yes','center',1);" target="_blank"
                                                                class=" "
