                        ...
                        <div class="tab-pane fade show active" id="navs-top-planformation" role="tabpanel">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($listedemandesss as $key => $demande)
                                        <tr>
                                            ...
                                            <td>{{ @$demande->code_projet_formation }}</td>
                                            <td>{{ $demande->date_soumis }}</td>
                                            <td>{{ $demande->date_instructions }}</td>
                                            <td>{{ $demande->date_soumis_cahier_plans_projets }}</td>
                                            <td align="rigth">
                                                {{ number_format($demande->cout_projet_instruction, 0, ',', ' ') }}
                                            </td>
                                            <td>
                                            ...
                                            <td align="center" nowrap="nowrap">
                                                @can($lien . '-edit')
                                                    <a href="{{ route($lien . '.editer.projetformation', [\App\Helpers\Crypt::UrlCrypt($comite->id_comite), \App\Helpers\Crypt::UrlCrypt($demande->id_demande), \App\Helpers\Crypt::UrlCrypt(1), \App\Helpers\Crypt::UrlCrypt($demande->id_cahier_plans_projets)]) }}"
                            ...
                            <div class="col-12" align="right">
                                ...
                                <a class="btn btn-sm btn-outline-secondary waves-effect"
                                    href="{{ route($lien . '.edit', [\App\Helpers\Crypt::UrlCrypt($comite->id_comite), \App\Helpers\Crypt::UrlCrypt(1)]) }}">
                                    Retour</a>
                            </div>
                        </div>
