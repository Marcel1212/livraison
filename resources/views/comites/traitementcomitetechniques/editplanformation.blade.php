                    ...
                    <div class="modal-body">
                        ...
                        <form id="editUserForm" class="row g-3" method="POST"
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <select class="select2 form-select" data-allow-clear="true" name="id_secteur_activite"
                                    id="id_secteur_activite">
                                    <option value="{{ @$infosactionplanformation->id_secteur_activitee }}">
                                        {{ @$infosactionplanformation->libelle_secteur_activite }} </option>
                            ...
                            <div class="col-12 col-md-4">
                                <label class="form-label" for="id_but_formation">But de la formation <strong
                                        style="color:red;">*</strong></label>
                                <select id="id_but_formation" name="id_but_formation"
                                    class="select2 form-select input-group @error('id_but_formation')
                                        error
                                        @enderror"
                                    aria-label="Default select example">
                                    <option value="{{ @$infosactionplanformation->id_but_formation }}">
                                        {{ @$infosactionplanformation->but_formation }} </option>
