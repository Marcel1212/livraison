                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-10 mx-auto">
                                                <!-- 1. Delivery Address -->
                                                <h5 class="my-4">
                                                    Renseigner le code de la livraison
                                                </h5>
                                                <form method="POST"
                                                    action="{{ route('traitementlivraisonprix.verification') }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="form-floating">
                                                                <input type="text" class="form-control"
                                                                    id="floatingInput" placeholder="ex: 120214585"
                                                                    required="required" name="code_livraison"
                                                                    id="code_livraison"
                                                                    aria-describedby="floatingInputHelp">
                                                                <label for="floatingInput">Code</label>
                                                                <div id="floatingInputHelp" class="form-text">
                                                                    Veuillez renseigner le code generer lors de votre
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-4 text-end mt-0">
                                                            <button class="btn  btn-lg   btn-outline-warning"
                                                                type="submit" name="submit">Verifier</button>
                                                        </div>
                                                    </div>
