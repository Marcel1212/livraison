...
@if (auth()->user()->can('traitementdemandehabilitation-index'))
    ...
    @section('content')
        <<<<<<< HEAD @php($Module = 'Habilitation') @php($titre = 'Liste des demandes habilitation')
            @php($lien = 'traitementdemandehabilitation')=======@php($Module = 'Habilitation') @php($titre = 'Liste des demandes d\'habilitation')
            @php($lien = 'traitementdemandehabilitation')>>>>>>> dev
