...
@if(auth()->user()->can('ctdemandehabilitation-index'))
                            ...
                            @foreach ($Resultat as $key => $res1)
                                @foreach ($res1 as $key => $habilitation)
                                    <tr>
                                        ...
                                        <td align="center">
                                            @can($lien.'-edit')
                                                <a href="{{ route($lien.'.editer',[\App\Helpers\Crypt::UrlCrypt($habilitation->id_demande_habilitation),\App\Helpers\Crypt::UrlCrypt($habilitation->id_combi_proc)]) }}"
                                                class=" "
                                                title="Modifier"><img
