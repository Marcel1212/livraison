...
@if(auth()->user()->can('traitementhabilitationrejete-edit'))
...
@section('content')
    ...
    @php($titre='Liste des demandes habilitation rejeté')
    ...
    <div class="content-body">
        ...
        @if($errors->any())
                        ...
                        <div class="col-xl-12">
                            <div align="right">
                                ...
                                @if($demandehabilitation->flag_rejet_demande_habilitation == true and $demandehabilitation->flag_reception_demande_habilitation == false)
                                        <button type="button"
        ...
        <script>
                ...
                $(document).on('click', '.modalToggleficheanalyse', function () {
                    ...
                    var id = $(this).data('id');
                   // alert(id)
                    $.get("{{ url('/') }}/traitementhabilitationrejete/" + id +"/ficheanalyse", function (data) {
