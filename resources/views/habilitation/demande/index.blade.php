...
@if (auth()->user()->can('demandehabilitation-index'))
    ...
    @section('content')
        ...
        @else
            <a href="#" class="btn btn-sm btn-info me-1 mt-1"> <i class="menu-icon tf-icons ti ti-plus"></i> Nouvelle
                demande</a>
        @endif
        >>>>>>> dev
    @endcan
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-5 mx-50">
                    @if ($formejuridique == 'PR')
                        @if (count($habilitations) < 1)
                            <a href="{{ route($lien . '.create') }}" class="btn btn-sm btn-info me-1 mt-1">Nouvelle
                                demande</a>
                        @else
                            <<<<<<< HEAD <a href="#" class="btn btn-sm btn-success me-1 mt-1">Demande d'expension
                                </a>
