...
{{--                                    <i class="menu-icon tf-icons ti ti-plus"></i>  demande--}}
{{--                                </button>--}}
{{--                                <div class="btn-group">--}}
...
{{--                                        <li><a class="dropdown-item" href="javascript:void(0);">Renouvellement Habilitation</a></li>--}}
...
{{--                                        <li><a class="dropdown-item" href="{{route('')}}">Suppression domaine de formation</a></li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
                            @endcan
                        </small>
                        ...
                        <table class="table table-bordered table-striped table-hover table-sm"
                            ...
                            @foreach ($habilitations as $key => $habilitation)
                                <tr>
                                    ...
                                    <td align="center">
                                        @can($lien.'-edit')
                                            <a href="{{ route($lien.'.edityancho',[\App\Helpers\Crypt::UrlCrypt($habilitation->id_demande_habilitation),\App\Helpers\Crypt::UrlCrypt(1)]) }}"
                                            class=" "
                                            title="Modifier"><img
