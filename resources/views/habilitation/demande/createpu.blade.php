                            ...
                            <form method="POST" class="form" action="{{ route($lien . '.store') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="nom_responsable_demande_habilitation"
                                                ...
                                                value="{{ old('nom_responsable_demande_habilitation') }}">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="fonction_demande_habilitation"
                                                ...
                                                required="required" value="{{ old('fonction_demande_habilitation') }}">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="contact_responsable_habilitation"
                                                ...
                                                required="required"
                                                value="{{ old('contact_responsable_habilitation') }}">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="maison_mere_demande_habilitation"
                                                ...
                                                value="{{ old('maison_mere_demande_habilitation') }}" />
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="num_id_impot" id="num_id_impot"
                                                class="form-control form-control-sm" value="{{ old('num_id_impot') }}" />
                                        </div>
                                        @error('num_id_impot')
                                            <div class=""><label class="error">{{ $message }}</label></div>
                                        @enderror
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="num_cnps_emp" id="num_cnps_emp"
                                                class="form-control form-control-sm" value="{{ old('num_cnps_emp') }}" />
                                        </div>
                                        @error('num_cnps_emp')
                                            <div class=""><label class="error">{{ $message }}</label></div>
                                        @enderror
                                    ...
                                    <div class="col-12" align="right">
                                        ...
                                        <button type="submit" name="action" value="EnregisterPU"
                                            class="btn btn-sm btn-primary me-1 waves-effect waves-float waves-light">
                                            Suivant
                                        </button>
