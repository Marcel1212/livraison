                            ...
                            <form method="post" enctype="multipart/form-data" action="{{ route($lien.'.extensiondomaineformationupdate', [\App\Helpers\Crypt::UrlCrypt($id),\App\Helpers\Crypt::UrlCrypt($id1),\App\Helpers\Crypt::UrlCrypt(1)]) }}">
                                ...
                                <div class="row">
                                            ...
                                            <select
                                                ...
                                                @foreach($motifs as $motif)
                                                    ...
                                                    <option value="{{$motif->id_motif}}"
                                                            @if(@$demande_extension->id_motif_demande_suppression_habilitation==@$motif->id_motif)
                                                                selected
                                    ...
                                    <div class="col-md-6 ">
                                        <label class="form-label">Pièce justificative <strong
                                                style="color:red;">*</strong></label>
                                        <div>
                                            @if($demande_extension->flag_soumis_demande_suppression_habilitation==false)
                                            ...
                                            @endif
                                            @isset($demande_extension->piece_demande_suppression_habilitation)
                                                <div>
                                ...
                                <div class="col-12" align="right">
                                    ...
                                    <a class="btn btn-sm btn-primary waves-effect"
                                       href="{{route('demandehabilitation.extensiondomaineformationedit',[\App\Helpers\Crypt::UrlCrypt($id),\App\Helpers\Crypt::UrlCrypt($id1),\App\Helpers\Crypt::UrlCrypt(2)])}}">
                                        Suivant</a>
                                </div>
                            </form>
                        </div>
                            ...
                            @csrf
                                ...
                                <div class="col-12" align="right">
                                    ...
                                    <a class="btn btn-sm me-1 btn-outline-secondary waves-effect" href="/{{$lien }}">
                                        Retour</a>
                                    <a  href="{{route('demandehabilitation.extensiondomaineformationedit',[\App\Helpers\Crypt::UrlCrypt($id),\App\Helpers\Crypt::UrlCrypt($id1),\App\Helpers\Crypt::UrlCrypt(1)])}}"  class="btn btn-sm btn-secondary me-1">Précédent</a>
                                ...
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12" align="right">
                                            ...
                                            @if($demande_extension->flag_soumis_demande_habilitation!=true)
...
\App\Helpers\Crypt::UrlCrypt($formateur->id_formateur_domaine_demande_habilitation)]) }}"
                            ...
                            <div class="col-12" align="right">
                                ...
                                <a class="btn btn-sm me-1 btn-outline-secondary waves-effect" href="/{{$lien }}">
                                    Retour</a>
                                <a  href="{{route('demandehabilitation.extensiondomaineformationedit',[\App\Helpers\Crypt::UrlCrypt($id),\App\Helpers\Crypt::UrlCrypt($id1),\App\Helpers\Crypt::UrlCrypt(2)])}}"  class="btn btn-sm btn-secondary me-1">Précédent</a>
                            </div>
                        </div>
