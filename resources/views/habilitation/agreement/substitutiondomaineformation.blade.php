                            ...
                            <div class="nav-align-top nav-tabs-shadow mb-4">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="navs-top-extensiondomaineformation" role="tabpanel">
                                        <form method="post" enctype="multipart/form-data" action="{{ route($lien.'.substitutiondomaineformationstore', [\App\Helpers\Crypt::UrlCrypt($id),\App\Helpers\Crypt::UrlCrypt(2)]) }}">
                                        @csrf
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-1">
