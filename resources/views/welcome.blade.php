                ...
                <div class="content">
                    <div class="hero-text-box">
                        <div class="row align-center">
                            <div class="col-xl-5 pl-60 section-py pr-50 pr-md-15 pr-xs-15"><h1 class="text-primary hero-title display-6 fw-bold">BienVenue sur votre espace
                                FDFP</h1>
                                <h2 class="hero-sub-title h6 mb-4 pb-1">
                                    Vous n'êtes pas encore enrôlés?<br class="d-none d-lg-block"/>
                     ...
                     >Effectuer ma
                         <img
                                 ...
                                 class="scaleX-n1-rtl"/>
                                    ...
                                    <a href="{{route('enrolements')}}" class="btn btn-primary btn-lg">Demande d'enrôlement</a>
                                </div>
                            </div>
              ...
              <script>
                document.write(new Date().getFullYear());
                    ...
                    <a href="{{route('/')}}" target="_blank"
                       class="fw-medium text-white footer-link">FDFP</a>
