                        ...
                        <div class="tab-pane fade @if($idetape==4) show active  @else disabled @endif" id="navs-top-traitement" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        ...
                                        <textarea rows="5" class="form-control" disabled>@isset($demande_extension->observation_instruction){{$demande_extension->observation_instruction}} @endisset</textarea>
                                    </div>
                                </div>
                        </div>
