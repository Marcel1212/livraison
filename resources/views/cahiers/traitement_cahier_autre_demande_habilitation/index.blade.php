                        ...
                        <table class="table table-bordered table-striped table-hover table-sm" id="exampleData"
                            ...
                            <tbody>
                                ...
                                @foreach ($resultat as  $res1)
                                    @foreach ($res1 as  $key =>$cahier_demande)
                                        <tr>
                                            <td>{{$key+1 }}</td>
                                            <td>{{ $cahier_demande->code_cahier_autre_demande_habilitations  }}</td>
                                            <td>
                                            ...
                                            <td>{{ date('d/m/Y',strtotime(@$cahier_demande->date_creer_cahier_autre_demande_habilitations))}}</td>
                                            <td>@isset($cahier_demande->date_soumis_cahier_autre_demande_habilitations){{ date('d/m/Y',strtotime(@$cahier_demande->date_soumis_cahier_autre_demande_habilitations))}}@endisset</td>
                                            <td>
