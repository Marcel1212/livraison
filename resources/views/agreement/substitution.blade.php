            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-hover table-sm"
                        ...
                        <tbody>
                            @foreach ($actionplanformations as  $key =>$action_formation)
                                <tr>
                                    <td>{{$key+1 }}</td>
                                    ...
                                    <td align="center">
                                        <a href="{{ route($lien.'.edit',['id'=>\App\Helpers\Crypt::UrlCrypt($action_formation->id_action_formation_plan_substi),'etape'=>\App\Helpers\Crypt::UrlCrypt(4)]) }}"
                                           class=" "
                                           title="Modifier"><img
