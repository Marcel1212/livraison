                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-top-annulation" aria-controls="navs-top-annulation" aria-selected="true">
                                ...
                                <div class="mb-1">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <select class="select form-select-sm input-group" data-allow-clear="true"
                                                disabled="disabled">
                                                @foreach ($pays as $pay)
                                                    <option value="{{ $pay->id }}"
                                                        @if ($infoentreprise->pay->indicatif == $pay->indicatif) selected @endif>
                                                        {{ $pay->indicatif }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="number" name="masse_salariale" id="masse_salariale"
                                        class="form-control form-control-sm"
                                        value="{{ $plan_de_formation->masse_salariale }}" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" name="part_entreprise" id="part_entreprise"
                                        class="form-control form-control-sm"
                                        value="{{ $plan_de_formation->part_entreprise }}" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" name="code_plan_formation" id="code_plan_formation"
                                        class="form-control form-control-sm"
                                        value="{{ $plan_de_formation->code_plan_formation }}" disabled="disabled">
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a onclick="NewWindow('{{ route('planformation.show', \App\Helpers\Crypt::UrlCrypt($actionplanformation->id_action_formation_plan)) }}','',screen.width*2,screen.height,'yes','center',1);"
                                                target="_blank" class=" " title="Modifier"><img
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <div class="mb-1">
                                                        ...
                                                        <select class="select2 form-select-sm input-group" disabled
                                                            data-allow-clear="true" name="id_motif_recevable"
                                                            id="id_motif_recevable">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-1">
                                                ...
                                                <textarea class="form-control" rows="3" id="exampleFormControlTextarea" name="evaluation_competences_odf"
                                                    style="height: 121px;" disabled>
@isset($demande_annulation_plan->commentaire_demande_annulation_plan)
{{ $demande_annulation_plan->commentaire_demande_annulation_plan }}
@endisset
</textarea>
                                            </div>
                                        </div>
                            ...
                            @else
                                <form method="POST" class="form"
                                    action="{{ route($lien . '.cancel.update', ['id_demande' => \App\Helpers\Crypt::UrlCrypt($demande_annulation_plan->id_demande_annulation_plan), 'id_plan' => \App\Helpers\Crypt::UrlCrypt($plan_de_formation->id_plan_de_formation)]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <select class="select2 form-select-sm input-group"
                                                            data-allow-clear="true" name="id_motif_demande_annulation_plan"
                                                            id="id_motif_demande_annulation_plan">
                                                            @foreach ($motifs as $motif)
                                                                <option value="{{ $motif->id_motif }}"
                                                                    @if ($motif->id_motif == $motif->id_motif_demande_annulation_plan) selected @endif>
                                                                    {{ $motif->libelle_motif }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <label class="form-label">Pièce justificatif de la demande d'annulation
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <textarea class="form-control form-control-sm" name="commentaire_demande_annulation_plan"
                                                    id="commentaire_demande_annulation_plan" rows="6">
@isset($demande_annulation_plan->commentaire_demande_annulation_plan)
{{ $demande_annulation_plan->commentaire_demande_annulation_plan }}
@endisset
</textarea>
                                        ...
                                        <div class="col-12" align="right">
                                            ...
                                            <button
                                                ...
                                                type="submit" name="action" value="Enregistrer_soumettre_plan_formation"
                                                class="btn btn-sm btn-success me-sm-3 me-1">Soumettre la demande
                                                d'annulation</button>
                        ...
                        @else
                            <form method="POST" class="form"
                                action="{{ route($lien . '.cancel.store', \App\Helpers\Crypt::UrlCrypt($plan_de_formation->id_plan_de_formation)) }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-2">
                                                <label class="form-label">Pièce justificatif de la demande d'annulation <strong
                                                        style="color:red;">*</strong></label>
                                                <input type="file" name="piece_demande_annulation_plan"
                                                    class="form-control form-control-sm" placeholder="" required="required"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            <label>Commentaire de la demande d'annuation <strong
                                                    style="color:red;">*</strong></label>
                                            <textarea class="form-control form-control-sm" name="commentaire_demande_annulation_plan"
                                                id="commentaire_demande_annulation_plan" rows="6">{{ old('commentaire_demande_annulation_plan') }}</textarea>
                                        </div>
                                    </div>
...
{{--                        {{ route($lien.'.update', \App\Helpers\Crypt::UrlCrypt($infosactionplanformation->id_action_formation_plan)) }} --}}
                        ...
                        <div class="col-12 col-md-9">
                            ...
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->raison_social_entreprises}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="masse_salariale">Masse salariale</label>
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->masse_salariale}}" --}}
                                disabled="disabled" />
                        </div>
                        ...
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="intitule_action_formation_plan">Intitulé de l'action de
                                formation</label>
                            <input type="text" class="form-control form-control-sm"
                                name="intitule_action_formation_plan" {{--                                    value="{{@$infosactionplanformation->intitule_action_formation_plan}}" --}} />
                        </div>
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="objectif_pedagogique_fiche_agre">Objectif pedagogique</label>
                            <input type="text" class="form-control form-control-sm"
                                name="objectif_pedagogique_fiche_agre" {{--                                    value="{{@$infosactionplanformation->objectif_pedagogique_fiche_agre}}" --}} />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="part_entreprise">Part entreprise</label>
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->part_entreprise}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="structure_etablissement_action_">Structure ou etablissemnt de
                                formation</label>
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->structure_etablissement_action_}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="nombre_stagiaire_action_formati">Nombre de stagiaires</label>
                            <input type="number" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->nombre_stagiaire_action_formati}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="nombre_groupe_action_formation_">Nombre de groupe</label>
                            <input type="number" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->nombre_groupe_action_formation_}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="nombre_heure_action_formation_p">Nombre d'heures par
                                groupes</label>
                            <input type="number" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->nombre_heure_action_formation_p}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label">Cout de la formation</label>
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->cout_action_formation_plan}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label">Type de formation</label>
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->type_formation}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="but_formation">But de la formation</label>
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->but_formation}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="date_debut_fiche_agrement">Date debut de realisation</label>
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->date_debut_fiche_agrement}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="date_fin_fiche_agrement">Date fin de realisation</label>
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->date_fin_fiche_agrement}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="lieu_formation_fiche_agrement">Lieu de formation</label>
                            <input type="text" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->lieu_formation_fiche_agrement}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="cout_total_fiche_agrement">Cout total fiche agrement</label>
                            <input type="number" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->cout_total_fiche_agrement}}" --}}
                                disabled="disabled" />
                        </div>

                        <div class="col-12 col-md-3">
                            <label class="form-label" for="cadre_fiche_demande_agrement">Nombre de cadre</label>
                            <input type="number" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->cadre_fiche_demande_agrement}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="agent_maitrise_fiche_demande_ag">Nombre d'agent de
                                maitrise</label>
                            <input type="number" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->agent_maitrise_fiche_demande_ag}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="employe_fiche_demande_agrement">Nombre d'employe /
                                ouvriers</label>
                            <input type="number" class="form-control form-control-sm" {{--                                    value="{{@$infosactionplanformation->employe_fiche_demande_agrement}}" --}}
                                disabled="disabled" />
                        </div>
                        <div class="col-12 col-md-3">
                            <div class="mb-1">
                                <label>Facture proforma </label> <br>
                                <span class="badge bg-secondary"><a target="_blank" Voir la pièce </a> </span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <label class="form-label" for="billings-country">Motif de non-financement <strong
                                    style="color:red;">(obligatoire si le montant accordé est egal a 0*)</strong></label>

                            <select class="form-select form-select-sm" data-allow-clear="true"
                                name="motif_non_financement_action_formation" id="motif_non_financement_action_formation">
                                {{--                                        <?= $motif ?> --}}
                            </select>
                        </div>
                        <div class="col-md-6 col-12">
