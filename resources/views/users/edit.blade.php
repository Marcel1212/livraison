                            ...
                            <form action="{{ route('users.update', \App\Helpers\Crypt::UrlCrypt($user->id)) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-12">
                                        <div class="mb-1">
                                            ...
                                            <select class="select2 select2-size-sm form-select" name="roles"
                                                id="profiles" onchange="changeFunc();">
                                                <?php echo $Roless; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            <label>Identifiant</label> <strong style="color: red">6 caractères
                                                minimum</strong>
                                            <input type="text" name="login_users" id="login_users"
                                                value="{{ $user->login_users }}" class="form-control form-control-sm"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="name" id="name" value="{{ $user->name }}"
                                                class="form-control form-control-sm" placeholder="Nom" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="prenom_users" id="prenom_users"
                                                value="{{ $user->prenom_users }}" class="form-control form-control-sm"
                                                placeholder="Prénoms" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            <label>Mot de passe</label> <strong style="color: red">8 caractères
                                                minimum</strong>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <select name="genre_users" id="genre_users"
                                                ...
                                                <option <?php if ($user->genre_users == 'Feminin') {
                                                    echo 'selected';
                                                } ?> value="Feminin">
                                                    Feminin
                                                </option>
                                                <option <?php if ($user->genre_users == 'Masculin') {
                                                    echo 'selected';
                                                } ?> value="Masculin">
                                                    Masculin
                                                </option>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="adresse_users" id="adresse_users"
                                                value="{{ $user->adresse_users }}" class="form-control form-control-sm"
                                                placeholder="Adresse">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" name="cel_users" id="cel_users"
                                                class="form-control form-control-sm" value="{{ $user->cel_users }}"
                                    ...
                                    <div class="col-md-2 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" name="tel_users" id="tel_users"
                                                class="form-control form-control-sm" value="{{ $user->tel_users }}"
                                                placeholder="Ex:  0102030405">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            <label>Actif </label>
                                            <select name="flag_actif_users" class="form-control form-control-sm ">
                                                <option value=true @if ($user->flag_actif_users == true) selected @endif>
                                                    Actif
                                                </option>
                                                <option value=false @if ($user->flag_actif_users == false) selected @endif>
                                                    Inactif
                                                </option>
                                            </select>
                            ...
                            <form method="POST" class="form"
                                ...
                                <div class="row">
                                    <div class="col-10 col-md-11">
                                        <select id="id_secteur_activite" name="id_secteur_activite"
