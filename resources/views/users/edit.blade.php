                                    ...
                                    <form action="{{ route('users.update',\App\Helpers\Crypt::UrlCrypt($user->id)) }}" method="POST">
                                        ...
                                        <?php }else{ ?>
                                            <div class="col-md-8 col-12">
                                                <div class="mb-1">
                                                    <label>Profil utilisateur</label>
                                                    <select class="select2 select2-size-sm form-select" name="roles" id="roles" disabled>
                                                      <?php echo $Roless; ?>
                                                        </select>
                                    ...
                                    <hr>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-10 col-md-11">
                                                            <label class="form-label" for="id_secteur_activite">joindre le secteur d'activite a cet utilisateur</label>
                                                            <select
