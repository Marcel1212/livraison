                            ...
                            <form action="{{ route($lien . '.store') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-12">
                                        <div class="mb-1">
                                            ...
                                            <select class="select2 select2-size-sm form-select" name="roles"
                                                id="profiles" onchange="changeFunc();" required>
                                                <?php echo $roles; ?>
                                            </select>
                                        </div>
                                        @error('roles')
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="mb-1">
                                            <label>Identifiant</label> <strong style="color: red">8 caractères
                                                minimum</strong>
                                            <input type="text" name="login_users" id="login_users"
                                                class="form-control form-control-sm" placeholder="Identifiant"
                                                minlength="8" value="{{ old('login_users') }}" required>
                                        </div>
                                        @error('login_users')
                                            <div class=""><label class="error">{{ $message }}</label></div>
                                        @enderror
                                    ...
                                    <div class="col-md-2 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" name="cel_users" id="cel_users"
                                                class="form-control form-control-sm" placeholder="Ex:  0102030405"
                                                value="{{ old('cel_users') }}">
                                        </div>
                                        @error('cel_users')
                                            <div class=""><label class="error">{{ $message }}</label></div>
