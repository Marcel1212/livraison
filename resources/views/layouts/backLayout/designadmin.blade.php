...
if (Auth::user()->photo_profil != '') {
    ...
    $iconUser = '/backendvuexy/assets/img/avatars/1.png';
}
$logo = Menu::get_logo();
...
<html
  ...
  <head>
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="{{asset('backendvuexy/assets/vendor/css/pages/cards-advance.css')}}" />
                      ...
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{asset('backendvuexy/assets/img/avatars/1.png')}}" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{asset('backendvuexy/assets/img/avatars/2.png')}}" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{asset('backendvuexy/assets/img/avatars/9.png')}}" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{asset('backendvuexy/assets/img/avatars/5.png')}}" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{asset('backendvuexy/assets/img/avatars/6.png')}}" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <li>
                      <a class="dropdown-item" href="pages-account-settings-account.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-medium d-block">{{Auth::user()->name.' '.Auth::user()->prenom_users}}</span>
                            <small class="text-muted">{{ $naroles }}<?php if (isset(Auth::user()->num_agce)) { ?> <em>  ({{@Auth::user()->agence->lib_agce}})</em><?php } ?></small>
                          </div>
                        </div>
                      </a>
                    </li>
