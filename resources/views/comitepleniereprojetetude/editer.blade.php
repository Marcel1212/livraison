                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade @if($id_etape==4) show active @endif" id="navs-top-traitementinstructionprojetetude" role="tabpanel">
                            ...
                            <div class="col-12" align="right">
                                ...
                                <form method="POST" class="form mb-2" action="{{ route($lien.'.cahierupdate', [\App\Helpers\Crypt::UrlCrypt($projet_etude->id_projet_etude),\App\Helpers\Crypt::UrlCrypt($idcomite),\App\Helpers\Crypt::UrlCrypt($id_etape)]) }}">
                                        @csrf
                                        @method('put')
                            ...
                            <form  method="POST" class="form" action="{{ route($lien.'.cahierupdate', [\App\Helpers\Crypt::UrlCrypt($projet_etude->id_projet_etude),\App\Helpers\Crypt::UrlCrypt($idcomite),\App\Helpers\Crypt::UrlCrypt($id_etape)]) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-12" align="right">
                                        ...
                                        <?php } ?>
                                        <a  href="{{ route($lien.'.editer',['id'=>\App\Helpers\Crypt::UrlCrypt($projet_etude->id_projet_etude),\App\Helpers\Crypt::UrlCrypt($idcomite),\App\Helpers\Crypt::UrlCrypt(3)]) }}"  class="btn btn-sm btn-secondary me-1" align="right">Précédent</a>
