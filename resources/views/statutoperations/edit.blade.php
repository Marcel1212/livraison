                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" class="form" action="{{ route($lien.'.update',\App\Helpers\Crypt::UrlCrypt($statutoperation->id_statut_operation)) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="checkbox" class="form-check-input" name="flag_statut_operation" {{  ($statutoperation->flag_statut_operation == true ? ' checked' : '') }}
                                                           id="colorCheck1">
                                                </div>
                                            </div>
