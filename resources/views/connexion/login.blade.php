...
<html
  ...
  <body>
    ...
    <div class="authentication-wrapper authentication-cover authentication-bg" style='background-color:##<?php echo @$couleur->mot_cle; ?>'>
      <div class="authentication-inner row">
        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            <!-- /Logo -->
            <h3 class="mb-1">Bienvenue sur e-FDFP 👋</h3>
            <p class="mb-4">Votre application de digitalisation de produits et services metiers.</p>
            ...
            <form id="formAuthentication" class="mb-3" action="{{ url('connexion') }}" method="POST">
              ...
              <button type="submit" class="btn btn-primary d-grid w-100">Je me connecte</button>
            </form>
            ...
            <div class="divider my-4">
              <div class="divider-text">
                    &copy; Tous droits réservés - <?php echo @$logo->titre_logo;?>
                                    - <?php echo date('Y'); ?>
              </div>
            </div>
