                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-9 mx-auto">
                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <label class="form-label" for="fullname">Dénomination sociale</label>
                              <input type="text" id="raison_sociale_demande_enroleme" name="raison_sociale_demande_enroleme" class="form-control" placeholder="ASSOCIATION SERVICE MEDIATION" required="required"/>
                            </div>
                            <div class="col-md-4">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <span class="input-group-text" id="email3" required="required"></span>
                              </div>
                            </div>
                            <div class="col-md-4">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <label class="form-label" for="state">Centre des impôts</label>
                          ...
                          <div class="row">
                            <div class="col-4 col-md-4">
                              <div class="mb-3">
                                <label class="form-label" for="collapsible-ncc-name">NCC</label>
                                <input
                                        type="text"
                                        id="collapsible-payment-name"
                                        class="form-control"
                                        placeholder="" name="ncc_demande_enrolement" required="required"/>
                              </div>
                            </div>
                            <div class="col-4 col-md-4">
                              <div class="mb-3">
                                <label class="form-label" for="collapsible-rccm-name">RCCM</label>
                                <input
                                        type="text"
                                        class="form-control"
                                        placeholder="" name="rccm_demande_enrolement" required="required"/>
                              </div>
                            </div>
                            <div class="col-4 col-md-4">
                              <div class="mb-3">
