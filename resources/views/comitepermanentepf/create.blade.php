...
@section('content')
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="date" name="date_debut_comite_permanente"
                                            id="date_debut_comite_permanente" class="form-control form-control-sm"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="date" name="date_fin_comite_permanente"
                                            id="date_fin_comite_permanente" class="form-control form-control-sm"
                                            onchange="verifierDateFin()" required />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea class="form-control form-control-sm" name="commentaire_comite_permanente"
                                            id="commentaire_comite_permanente" rows="6"></textarea>
    ...
    <script>
        function verifierDate() {
            ...
            var dateSelectionnee = new Date(document.getElementById("date_debut_comite_permanente").value);
            ...
            if (dateSelectionnee.getTime() === dateDuJour.getTime()) {
                ...
                var champ = document.getElementById("date_debut_comite_permanente");
                champ.value = "";
            }

            var dateFin = new Date(document.getElementById("date_fin_comite_permanente").value);
        ...
        function verifierDateFin() {
            ...
            // Obtenez la date sélectionnée (à des fins de démonstration, vous pouvez remplacer cela par la manière dont vous obtenez la date sélectionnée dans votre application)
            var dateSelectionnee = new Date(document.getElementById("date_fin_comite_permanente").value);
            //alert(dateSelectionnee);
            ...
            if (dateSelectionnee.getTime() === dateDuJour.getTime()) {
                ...
                //alert("Veuillez selectionner une autre date car celle-ci est déjà passé");
                document.getElementById("Btn2").click();
                var champ = document.getElementById("date_fin_comite_permanente");
                champ.value = "";
            }

            var dateDebut = new Date(document.getElementById("date_debut_comite_permanente").value);
            var dateFin = new Date(document.getElementById("date_fin_comite_permanente").value);
            //alert(dateDebut);
            if (dateFin.getTime() < dateDebut.getTime()) {
                //alert('La date de fin doit être superieur à la date de debut');
                document.getElementById("Btn1").click();
                var champFin = document.getElementById("date_fin_comite_permanente");
                champFin.value = "";
            }
        }
    </script>
