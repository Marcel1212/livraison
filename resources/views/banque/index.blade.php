                                ...
                                <div class="card mb-4">
                                    ...
                                    <table class="table table-bordered table-striped table-hover table-sm "
                                        ...
                                        @foreach ($banques as $key => $banque)
                                            <tr>
                                                <td>{{ ++$i }}</td>
                                                <td>{{ $banque->libelle_banque }}</td>
                                                <td align="center">
                                                    <?php if ($banque->flag_banque == true ){?>
                                                ...
                                                <td align="center">
                                                    @can($lien.'-edit')
                                                        <a href="{{ route($lien.'.edit',\App\Helpers\Crypt::UrlCrypt($banque->id_banque)) }}"
                                                           class=" "
