                    ...
                    <table class="table table-bordered table-striped table-hover table-sm" id="exampleData"
                        ...
                        <tbody>
                            ...
                            @foreach ($Resultat as $key => $comitep)
                                <tr>
                                    <td>{{ ++$i }}</td>
                                    <td>{{ @$comitep->code_comite_pleniere_pf }}</td>
                                    <td>{{ $comitep->date_debut_comite_pleniere_pf }}</td>
                                    <td>{{ $comitep->date_fin_comite_pleniere_pf }}</td>
                                    <td align="center">
                                        <?php if($comitep->flag_statut_comite_pleniere_pf == true){ ?>
                                    ...
                                    <td align="center">
                                        @can($lien . '-edit')
                                            <a href="{{ route($lien . '.edit', \App\Helpers\Crypt::UrlCrypt($comitep->id_comite_pleniere_pf)) }}"
