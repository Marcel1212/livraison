                    ...
                    <div class="tab-pane fade show active" id="navs-top-actionformation" role="tabpanel">
                        ...
                        <div class="col-12" align="right">
                            ...
                            <form method="POST" class="form"
                                action="{{ route($lien . '.cahierupdate', [\App\Helpers\Crypt::UrlCrypt($planformation->id_plan_de_formation), \App\Helpers\Crypt::UrlCrypt($idcomite)]) }}">
                                @csrf
                                @method('post')
                ...
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form id="editUserForm" class="row g-3" method="POST"
                            action="{{ route($lien . '.cahierupdate', [\App\Helpers\Crypt::UrlCrypt($infosactionplanformation->id_action_formation_plan), \App\Helpers\Crypt::UrlCrypt($idcomite)]) }}">
                            @csrf
                            @method('post')
