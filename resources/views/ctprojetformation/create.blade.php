                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="date" name="date_debut_comite_pleniere_pf"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="date" name="date_fin_comite_pleniere_pf"
                                            class="form-control form-control-sm" required />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea class="form-control form-control-sm" name="commentaire_comite_pleniere_pf" id="commentaire_comite_pleniere"
                                            rows="6"></textarea>
