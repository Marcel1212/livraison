@if(auth()->user()->can('butformation-edit'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" class="form" action="{{ route($lien.'.update',\App\Helpers\Crypt::UrlCrypt($butformation->id_but_formation)) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-10 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" name="but_formation" id="but_formation"
                                                           class="form-control form-control-sm" value="{{$butformation->but_formation}}"
                                                           required>
                                                </div>
                                            </div>
