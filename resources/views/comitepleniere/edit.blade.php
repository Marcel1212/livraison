                  ...
                  <div class="nav-align-top nav-tabs-shadow mb-4">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <button
                          type="button"
                          class="nav-link <?php if(count($planformations)>0 and count($comitepleniereparticipant)>=1){ echo "active";}?>"
                          role="tab"
                          data-bs-toggle="tab"
                      ...
                      <li class="nav-item">
                        <button
                          type="button"
                          class="nav-link <?php if(count($cahiers)>=1 and count($comitepleniereparticipant)>=1){ echo "active";} ?>"
                          role="tab"
                          data-bs-toggle="tab"
                    ...
                    <div class="tab-content">
                            ...
                            <form  method="POST" class="form" action="{{ route($lien.'.update', \App\Helpers\Crypt::UrlCrypt($comitepleniere->id_comite_pleniere)) }}" enctype="multipart/form-data">
                                      ...
                                      <div class="row">
                                          <div class="col-12 col-md-10">
                                              <label class="form-label" for="id_user_comite_pleniere_participant">Conseiller <strong style="color:red;">*</strong></label>
                                              <select
                        ...
                        <div class="tab-pane fade <?php if(count($planformations)>0 and count($comitepleniereparticipant)>=1){ echo "active";} ?>" id="navs-top-actionformation" role="tabpanel">
                        ...
                        <div class="tab-pane fade<?php if(count($cahiers)>=1 and count($comitepleniereparticipant)>=1){ echo "active";} ?>" id="navs-top-cahieraprescomite" role="tabpanel">
