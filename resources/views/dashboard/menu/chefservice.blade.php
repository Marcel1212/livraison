...
$demandehabilitationsnv = ListeDemandeHabilitationSoumis::get_liste_demande_habilitation_soumis($numAgce);
                        ...
                        <tr>
                            ...
                            <td class="text-end pt-2">
                                <div class="user-progress mt-lg-4">
                                     @can($lien.'-edit')
                                        <a href="{{ route($lien.'.edit',\App\Helpers\Crypt::UrlCrypt($demandehabilitation->id_demande_habilitation)) }}"
                                           class=" "
