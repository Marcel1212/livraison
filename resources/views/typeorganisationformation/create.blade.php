@if(auth()->user()->can('typeorganisationformation-create'))
...
@section('content')
    ...
    @php($soustitre='Ajouter un type organisation formation')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="checkbox" class="form-check-input" name="flag_type_organisation_formation"
                                                           id="colorCheck1">
                                                </div>
                                            </div>
