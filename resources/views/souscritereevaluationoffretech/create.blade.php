{{--@if(auth()->user()->can('souscritereevaluationoffretech-create'))--}}
...
@section('content')
    ...
    @php($soustitre='Ajouter un sous critère d\'évaluation d\'une offre technique')
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    @isset($critereevaluationoffretechs)
                                                            @foreach(@$critereevaluationoffretechs as $critereevaluationoffretech)
                                                                <option value="{{@$critereevaluationoffretech->id_critere_evaluation_offre_tech}}">{{@$critereevaluationoffretech->libelle_critere_evaluation_offre_tech}}</option>
                                                            @endforeach
                                                        @endisset
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-2 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="checkbox" class="form-check-input" name="flag_sous_critere_evaluation_offre_tech"
                                                           id="colorCheck1">
                                                </div>
                                            </div>
